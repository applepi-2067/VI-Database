...
' $1="$2$3$4"').match(/[cC][lL][aA][sS][sS]=\"[^\"]*\bnocode\b/)){var x=d.match(N)[2],t=1,v;v=f+1;e:for(;v<u;++v){var l=h[v].match(N);if(l&&l[2]===x)if("/"===l[1]){if(0===--t)break e}else++t}v<u?(g.push(r,h.slice(f,v+1).join("")),f=v):g.push(r,d)}else g.push(r,d)}else{var c;var t=d,q=t.indexOf("&");if(0>q)c=t;else{for(--q;0<=(q=t.indexOf("&#",q+1));){var e=t.indexOf(";",q);if(0<=e){var p=t.substring(q+3,e),k=10;p&&"x"===p.charAt(0)&&(p=p.substring(1),k=16);var y=parseInt(p,k);isNaN(y)||(t=t.substring(0,
